...
The layout will automatically move widgets to the next row if they don't fit within a given row. La hauteur de chaque ligne est déterminée par le widget le plus haut de cette ligne.
