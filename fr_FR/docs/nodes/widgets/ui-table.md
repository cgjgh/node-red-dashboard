...
_Example of a rendered data table in a Dashboard._
...
_Example of a table that has "Multi Selection" enabled._
...
_Example of a data table that enables a row to be selected/clicked._

### Pagination

![Example of a Paginated Table](/images/node-examples/ui-table-pagination.png "Example of a Paginated Table"){data-zoomable}
_Example of a paginated table which has 10 rows of data, but with "Max Rows" set to 5._
